<template>
  <q-page>
    <div v-if="dimensioneListaRisposte > 100">
      <PrologoComponent
      ...
      <q-card flat>
        <q-card-section horizontal>
          <q-card-section class="col-6 container">
            <q-scroll-area visible style="height: calc(60vh); max-height: calc(60vh)" :thumb-style="thumbStyle"
              :bar-style="barStyle">
              ...
              <div class="row">
                <div class="col-auto" v-for="risposta in lista_risposte_disponibili" :key="risposta.id">
                  <p class="q-ma-sm item" draggable="true" @dragstart="startDrag($event, risposta.testo)">
                    ...
                    <span class="bg-teal-1 q-pa-xs rounded border-solid" v-html="risposta.label"></span>
                  </p>
                </div>
              </div>
